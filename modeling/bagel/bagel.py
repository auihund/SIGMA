...
class Bagel(PreTrainedModel):
    ...
    def forward(
        ...
        """
        # print(f"self.language_model.model.layers[1].self_attn.v_proj.bias: {self.language_model.model.layers[1].self_attn.v_proj.bias}")
        # print(f"self.language_model.model.layers[20].self_attn.q_norm_moe_gen.weight: {self.language_model.model.layers[20].self_attn.q_norm_moe_gen.weight}")
        packed_text_embedding = self.language_model.model.embed_tokens(packed_text_ids) if hasattr(self.language_model.model, "embed_tokens") else self.language_model.model.base_model.embed_tokens(packed_text_ids)
