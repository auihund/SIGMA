...
class PackedDataset(torch.utils.data.IterableDataset):
    ...
    def build_datasets(self, datasets_metainfo, data_status):
        ...
        for grouped_dataset_name, dataset_args in datasets_metainfo.items():
            ...
            if 'image_generate_transform_args' in dataset_args.keys():
                generate_transform = ImageTransform(**dataset_args.pop('image_generate_transform_args'))
                dataset_args['generate_transform'] = generate_transform
