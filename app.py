...
parser.add_argument("--visual_gen", type=bool, default=True)
parser.add_argument("--visual_und", type=bool, default=False)
...
if torch.cuda.device_count() == 1:
    ...
    for k in same_device_modules:
        if k in device_map:
            device_map[k] = first_device
ema_model_path = "/opt/liblibai-models/user-workspace2/users/wgy/code/Bagel/results_gen_shuffle_all_param_0/checkpoints/0018200"
if args.mode == 1:
    ...
    model = load_and_quantize_model(
        model, 
        weights_location=os.path.join(ema_model_path, "ema.safetensors"), 
